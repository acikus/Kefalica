...
# Serbian Cyrillic characters (uppercase)
SERBIAN_CYRILLIC = [
    "А", "Б", "В", "Г", "Д", "Ђ", "Е", "Ж", "З", "И", "Ј", "К", "Л", "Љ", "М", "Н",
    "Њ", "О", "П", "Р", "С", "Т", "Ћ", "У", "Ф", "Х", "Ц", "Ч", "Џ", "Ш"
]

# Define vowels (for Serbian Cyrillic)
VOWELS = {"А", "Е", "И", "О", "У"}
...
LETTER_BG_COLORS = dict(zip(SERBIAN_CYRILLIC, LIGHT_COLORS))
...
DICT_PATH = os.path.join(current_dir, "assets", "serbian-words.txt")
...
class LetterSpawner:
    ...
    def refill_letter_queue(self):
        ...
        for _ in range(num_extra_letters):
            ...
            mixed_letters.insert(insert_pos, random.choice(SERBIAN_CYRILLIC))
